    ...
    <div className="space-y-2">
      {candidates.map((candidate) => (
        <div key={candidate.id} className="group relative">
          <Button
            ...
            className="w-full justify-start text-left pr-12 border-black/5 hover:bg-black/5"
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="absolute right-0 top-0 opacity-0 group-hover:opacity-100 transition-opacity border-black/5 hover:bg-black/5"
                  onClick={(e) => {
                    e.stopPropagation();
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogTrigger asChild>
          <Button
            variant="ghost"
            className="w-full justify-start gap-2 border-black/5 hover:bg-black/5"
          >
