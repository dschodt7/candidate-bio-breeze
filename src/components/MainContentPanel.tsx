  ...
  const displayCards = [
    {
      ...
      className: `[grid-area:stack] -translate-y-10 hover:-translate-y-12 cursor-pointer ${activeSection === 'linkedin' ? 'ring-2 ring-blue-500' : ''}`,
    ...
    },
    {
      ...
      className: `[grid-area:stack] translate-x-16 translate-y-10 hover:translate-y-8 cursor-pointer ${activeSection === 'resume' ? 'ring-2 ring-indigo-500' : ''}`,
    ...
    },
    {
      ...
      className: `[grid-area:stack] translate-x-32 translate-y-20 hover:translate-y-18 cursor-pointer ${activeSection === 'screening' ? 'ring-2 ring-green-500' : ''}`,
