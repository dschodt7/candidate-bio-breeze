  ...
  const displayCards = [
    {
      ...
      className: `[grid-area:stack] -translate-y-10 cursor-pointer ${activeSection === 'linkedin' ? 'ring-2 ring-blue-500' : ''}`,
    ...
    },
    {
      ...
      className: `[grid-area:stack] translate-x-16 cursor-pointer ${activeSection === 'resume' ? 'ring-2 ring-indigo-500' : ''}`,
    ...
    },
    {
      ...
      className: `[grid-area:stack] translate-x-32 translate-y-20 cursor-pointer ${activeSection === 'screening' ? 'ring-2 ring-green-500' : ''}`,
