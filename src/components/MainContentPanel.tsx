...
const MainContentPanel = () => {
  ...
  const displayCards = [
    ...
    },
    {
      ...
      className: `[grid-area:stack] translate-x-16 translate-y-10 hover:-translate-y-4 cursor-pointer ${activeSection === 'resume' ? 'ring-2 ring-indigo-500' : ''}`,
    ...
    },
    {
      ...
      className: `[grid-area:stack] translate-x-32 translate-y-20 hover:-translate-y-4 cursor-pointer ${activeSection === 'screening' ? 'ring-2 ring-green-500' : ''}`,
