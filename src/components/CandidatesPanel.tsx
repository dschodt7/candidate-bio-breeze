    ...
    <div className="relative">
      <div className="relative">
        <button
          ...
          className="absolute right-[10px] z-50 top-4 flex h-6 w-6 items-center justify-center rounded-full border border-black/5 bg-background shadow-sm hover:bg-accent transition-colors"
        >
